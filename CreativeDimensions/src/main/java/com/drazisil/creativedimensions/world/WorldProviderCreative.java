...
import com.drazisil.creativedimensions.world.biome.BiomeProviderCreative;
import com.drazisil.creativedimensions.world.gen.ChunkProviderCreative;
...
public class WorldProviderCreative extends WorldProvider
{
    ...
    {
        this.biomeProvider = new BiomeProviderCreative(Biomes.SKY);
        this.hasNoSky = true;
        NBTTagCompound nbttagcompound = this.worldObj.getWorldInfo().getDimensionData(DimensionType.valueOf("creative"));
    }
    ...
    {
        if (this instanceof WorldProviderCreative)
        {
            return "Entering Creative";
        }
        return null;
    }
    ...
    public DimensionType getDimensionType() {
        return DimensionType.valueOf("creative");
    };
