...
jsROM.prototype.stripSMCHeader = function() {

    this.rawCart.ROMmemory = this.rawCart.ROMmemory.subarray(512);

};

jsROM.prototype.rom2cart = function(addr) {
...
jsROM.prototype.cart2rom = function(addr) {
    switch (this.romLayout)
    {
        case 32:
